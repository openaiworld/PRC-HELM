...
- **迭代健康度评分**：从生产力、工程文化、用户价值、团队能力四个维度做收尾评估。
...
├── references/
│   ├── templates.md                 # 需求、技术选型、RFC、ADR、PR、复盘等模板
...
```text
使用 $prc-helm 为“用户登录重构”制定实施计划，要求包含主要矛盾、执行模式、风险、验证方式和后续文档。
```
...
Agent 应输出本轮完成情况、未解决风险、下一阶段主要矛盾、迭代健康度评分，以及建议更新的文档，如 `progress.md`、`CHANGELOG.md`、`docs/retrospective/YYYY-MM-DD.md`。
...
| `references/templates.md` | 常用治理模板：需求、技术选型、spike、RFC、ADR、PR、复盘等 |
