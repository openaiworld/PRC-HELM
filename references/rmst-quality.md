...
```text
.ai_helm/quality/reliability/slo-service.md
.ai_helm/quality/reliability/fallback-service.md
.ai_helm/quality/reliability/alerts.md
.ai_helm/quality/reliability/chaos-YYYY-QN.md
```
...
```text
.ai_helm/quality/scalability/extension-points.md
.ai_helm/quality/scalability/api-versioning.md
.ai_helm/quality/scalability/perf-baseline-YYYY-MM.md
.ai_helm/quality/scalability/stateless-design.md
```
...
```text
.ai_helm/quality/traceability/matrix.md
.ai_helm/quality/traceability/observability.md
.ai_helm/decisions/adr/
CHANGELOG.md
```
